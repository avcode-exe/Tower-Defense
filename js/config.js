...
const MONSTER_SPECS = {
  1: { name: 'Grunt',    hp: 30,   speed: 1.0, reward: 4,  leak: 1, color: '#7ec07e', size: 11 },
  2: { name: 'Runner',   hp: 25,   speed: 1.8, reward: 6,  leak: 1, color: '#9be37a', size: 10 },
  3: { name: 'Brute',    hp: 120,  speed: 0.7, reward: 11, leak: 1, color: '#c0a060', size: 14 },
  4: { name: 'Elite',    hp: 220,  speed: 1.0, reward: 17, leak: 2, color: '#d96a6a', size: 13 },
  5: { name: 'Champion', hp: 600,  speed: 0.9, reward: 36, leak: 3, color: '#a86ad9', size: 16 },
  B: { name: 'Boss',     hp: 1500, speed: 0.6, reward: 81, leak: 5, color: '#e74c3c', size: 22 },
};
...
const TROOP_SPECS = [
  ...
  { id: 'mage',      name: 'Mage',      type: 'ranged', cost: 200, damage: 25, range: 4, attackSpeed: 1.1, splash: 1.5, color: '#9b59b6', hotkey: '5' },
