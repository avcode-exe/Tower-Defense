...
function benchmarkLoop(fn, count, label) {
  ...
  console.log(
    `  [${label}] ${count} iterations: total=${totalMs.toFixed(3)}ms  avg=${avgMs.toFixed(6)}ms`
  );
...
describe('performance hot-paths', () => {
  ...
  describe('_buildTroopTileIndex', () => {
    it('builds tile index for 12 troops within time budget', () => {
      ...
      assertFast(
        ...
        ITERATIONS,
        '_buildTroopTileIndex (12 troops)'
      );
    });
  ...
  describe('_updateMonsterTileIndex', () => {
    ...
    it('updates tile index for 0 monsters (no-op)', () => {
      ...
      assertFast(
        () => game._updateMonsterTileIndex(),
        ITERATIONS * 2,
        '_updateMonsterTileIndex (0 monsters)'
      );
    });
  });
  ...
  describe('step() frame time', () => {
    it('step with 5 troops + 10 monsters', () => {
      ...
      assertFast(
        () => game.step(1 / 60),
        ITERATIONS,
        'step() with 5 troops + 10 monsters'
      );
    });
    ...
    it('step with 12 troops + 50 monsters (max load)', () => {
      ...
      assertFast(
        () => game.step(1 / 60),
        ITERATIONS_HEAVY,
        'step() with 12 troops + 50 monsters'
      );
    });
  ...
  describe('cleanup overhead', () => {
    it('cleanup after 50 dead monsters + 12 dead troops', () => {
      ...
      assertFast(
        () => game._cleanupDead(),
        ITERATIONS,
        '_cleanupDead (50 dead monsters + 12 dead troops)'
      );
    });
  });
});
  ...
  describe('particle effect spawns', () => {
    ...
    it('deathBurst particle effect within time budget', async () => {
      ...
      assertFast(
        () => P.deathBurst(100, 100, '#0f0'),
        ITERATIONS,
        'PARTICLES.deathBurst() (real)'
      );
    });
    ...
    it('chainSpark particle effect within time budget', async () => {
      ...
      assertFast(
        () => P.chainSpark(100, 100),
        ITERATIONS,
        'PARTICLES.chainSpark() (real)'
      );
    });
    ...
    it('mixed particle effects (alternating) within time budget', async () => {
      ...
      assertFast(
        (i) => effects[i % effects.length](),
        ITERATIONS,
        'PARTICLES mixed (10 effect types, alternating)'
      );
    });
  });
  ...
  describe('monster damage mechanics', () => {
    it('damageMonster without shield (direct HP damage)', () => {
      ...
      assertFast(
        ...
        ITERATIONS,
        'damageMonster (direct, no shield)'
      );
    });
    ...
    it('damageMonster with monster split (level > 1)', () => {
      ...
      assertFast(
        () => game.damageMonster(m, 200),
        ITERATIONS_HEAVY,
        'damageMonster (with split at level 5)'
      );
    });
    ...
    it('monster takeDamage with shatter bonus', () => {
      ...
      assertFast(
        () => m.takeDamage(20),
        ITERATIONS,
        'monster takeDamage (shatter bonus)'
      );
    });
  });
  ...
  describe('troop damage mechanics', () => {
    ...
    it('damageTroop applied by monster to melee troop', () => {
      ...
      assertFast(
        () => game.damageTroop(m, t),
        ITERATIONS,
        'damageTroop (melee reduction)'
      );
    });
    ...
    it('damageTroop by revive-immune monster', () => {
      ...
      assertFast(
        () => game.damageTroop(m, t),
        ITERATIONS,
        'damageTroop (revive-immune monster)'
      );
    });
  });
  ...
  describe('AoE combat', () => {
    ...
    it('chainHitAt with chain count 2 and nearby monsters', () => {
      ...
      assertFast(
        () => game.chainHitAt(300, 300, dummyTroop),
        ITERATIONS_HEAVY,
        'chainHitAt (chain 2, 10 monsters)'
      );
    });
  ...
  describe('monster update mechanics', () => {
    it('monster _updateBurn with active stacks', () => {
      ...
      assertFast(
        () => m._updateBurn(1 / 60),
        ITERATIONS,
        'monster _updateBurn (3 stacks, ticking)'
      );
    });
    ...
    it('monster _updateRegen with shield and passive heal', () => {
      ...
      assertFast(
        () => m._updateRegen(1 / 60),
        ITERATIONS,
        'monster _updateRegen (shield + boss heal)'
      );
    });
    ...
    it('monster findTarget with troop tile index (12 troops)', () => {
      ...
      assertFast(
        () => m.findTarget(game._troopTileIndex),
        ITERATIONS,
        'monster findTarget (12 troops nearby)'
      );
    });
  });
  ...
  describe('projectile mechanics', () => {
    it('acquireProjectile from pool (warm cache)', () => {
      ...
      assertFast(
        () => game.acquireProjectile(dummyTroop, null, 100, 100),
        ITERATIONS,
        'acquireProjectile (from pool)'
      );
    });
    ...
    it('projectile update flying toward target', async () => {
      ...
      assertFast(
        () => proj.update(1 / 60, [], vi.fn()),
        ITERATIONS,
        'projectile update (flying)'
      );
    });
  ...
  describe('wave mechanics', () => {
    it('wave popDueMonster (not started)', () => {
      ...
      assertFast(
        () => game.wave.popDueMonster(),
        ITERATIONS,
        'wave popDueMonster (not started)'
      );
    });
  ...
  describe('troop economy', () => {
    ...
    it('troop getTotalInvested with upgrades', () => {
      ...
      assertFast(
        () => t.getTotalInvested(),
        ITERATIONS,
        'troop getTotalInvested (with upgrades)'
      );
    });
    ...
    it('canPlace occupied tile returns false', () => {
      ...
      assertFast(
        () => game.canPlace(1, 1, swordsmanSpec),
        ITERATIONS,
        'canPlace (occupied tile)'
      );
    });
    ...
    it('canPlace valid tile returns false for waypoint', () => {
      ...
      assertFast(
        () => game.canPlace(5, 5, swordsmanSpec),
        ITERATIONS,
        'canPlace (waypoint tile — not buildable)'
      );
    });
  });
  ...
  describe('game state helpers', () => {
    it('_getPopup with pool reuse', () => {
      ...
      assertFast(
        () => game._getPopup('+5', 100, 100, 1.2, '#f1c40f'),
        ITERATIONS,
        '_getPopup (pool reuse)'
      );
    });
    ...
    it('_stepPopups with 100 popups', () => {
      ...
      assertFast(
        () => game._stepPopups(0.016),
        ITERATIONS,
        '_stepPopups (100 popups, decaying)'
      );
    });
    ...
    it('_stepWaveCompletion (not due — early return)', () => {
      ...
      assertFast(
        ...
        ITERATIONS * 2,
        '_stepWaveCompletion (early return)'
      );
    });
  });
