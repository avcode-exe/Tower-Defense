...
export const CONFIG = {
  ...
  // UI / gameplay magic numbers
  DEV_MODE_CLICK_THRESHOLD: 3,
  DEV_MODE_CLICK_WINDOW_MS: 800,
  WAVE_TRANSITION_DURATION: 2.5,
  AUTO_SAVE_DEBOUNCE_MS: 5000,
  AUTO_SAVE_DEBOUNCE_WAVES: 5,
  REVIVE_REWARD_HP_RATIO: 0.08,
  POPUP_ANIM_MS: 300,
